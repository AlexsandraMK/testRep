...
Выходные данные:
Название - if_reg_success, Тип - число, Описание - получилось ли изменение:
    1 - 200, если получилось -> обновить страницу профиля питомца
    2 - 1, если что-то не заполнено или такой питомец у пользователя уже используется в системе
    {
        Саша отправит текст ошибки
    }
